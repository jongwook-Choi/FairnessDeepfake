...
class Stage2Trainer:
    """
    Stage 2 Linear Probing / Fine-tuning Trainer
    ...
    def __init__(self, config):
        ...
        experiment_name = log_config.get('experiment_name', 'stage2')
    ...
    def train(self):
        ...
        self.logger.log_info("Stage 2 Linear Probing Training Started")
        self.logger.log_info("=" * 60)
