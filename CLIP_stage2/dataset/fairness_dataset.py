...
class FairnessDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # subgroup, gender, race 정보도 함께 반환
        return (image, label, subgroup, gender, race, None, None, None, video_name)

    @staticmethod
    def collate_fn(batch):
        """배치 데이터 collate"""
        (images, labels, subgroups, genders, races, patch_labels,
        ...
        genders = torch.LongTensor(genders)
        races = torch.LongTensor(races)
