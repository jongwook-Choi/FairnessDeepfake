"""
CLIP Stage1 Training Script
Subgroup bias 제거를 위한 Additive Adapter 학습
...
from trainer.stage1_trainer import Stage1Trainer
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CLIP Stage1 Training')
